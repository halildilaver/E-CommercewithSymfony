...
class MessagesController extends AbstractController
{
    ...
    /**
     * @Route("/usermessages", name="admin_user_message")
     */
    public function usermessage(MessagesRepository $messagesRepository): Response
    {
        $messages = $messagesRepository->findBy(
            ['ifuser'=> 'TRUE']
        );
        //$messagesRepository->findAll()
        return $this->render('admin/user/usermessages.html.twig', ['messages' => $messages]);
    }
    ...
    public function message_update($id,Request $request, Messages $message): Response
    {
        ...
        $sql2 = 'UPDATE messages SET status= "Yanıtlandı" WHERE id=:id';
